...
# Backwards-compatibility re-export. ``ContTempInstNetwork`` was moved to
# ``tempnet._legacy`` (Phase 1.5). The import lives at the bottom of the
# module to avoid a circular import: ``_legacy`` itself imports
# ``ContTempNetwork`` from this module. The re-export keeps existing
# ``from tempnet.temporal_network import ContTempInstNetwork`` calls and
# pickle reductions working.
from ._legacy import ContTempInstNetwork  # noqa: E402, F401
